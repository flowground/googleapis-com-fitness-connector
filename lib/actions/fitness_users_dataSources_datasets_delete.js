 ...
 *
 *
 * Operation: 'fitness.users.dataSources.datasets.delete'
 * Endpoint Path: '/{userId}/dataSources/{dataSourceId}/datasets/{datasetId}'
 * Method: 'delete'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/{userId}/dataSources/{dataSourceId}/datasets/{datasetId}',
        method: 'delete',
